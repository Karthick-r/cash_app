            ...
            <div class="col-md-6">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="basic-layout-card-center">Add New Employe</h4>
               ...
               <form action="{{ route ('employe.update', $admin->id ) }}" method="post" >
          ...
          <input name="_method" type="hidden" value="PUT">
               ...
               <div class="form-group col-12 mb-2{{ $errors->has('name') ? ' has-error' : '' }}">
                   <label for="eventRegInput2">  Name</label>
                       ...
                       <input id="fname" type="text" class="form-control" name="name" value="{{ $admin->name }}"
                ...
                <input type="text" value="{{ $admin->phone }}"  id="phone" name="phone" class="form-control" placeholder="Enter Phone Number">
                @if ($errors->has('phone'))
                                    <span class="help-block">
