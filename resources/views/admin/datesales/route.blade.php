   ...
   <section id="dom">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Route Report</h4>
                  ...
                  <div class="heading-elements" style="top:11px; right:100px">
                   ...
                   <div class="col-sm-12">
                        ...
                        <form method="post" action="{{ route('datesales.store') }}">
         ...
         <option value=="0">ALL Route</option>
           ...
           @foreach($route as $route)
            <option value="{{$route->route_id}}" <?php if($val == $route->route_id){echo 'selected';}?> >{{$route->route_name}}</option>
           @endforeach
