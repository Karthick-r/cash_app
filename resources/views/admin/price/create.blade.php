            ...
            <div class="col-md-6">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="basic-layout-card-center"> Price</h4>
               ...
               <div class="form-group col-12 mb-2{{ $errors->has('name') ? ' has-error' : '' }}">
                   <label for="eventRegInput2">  Bottle Price</label>
                       ...
                       <input id="fname" type="number" class="form-control" name="name" 
                   ...
                   <label for="eventRegInput2">  Water Price</label>
                       ...
                       <input id="fname" type="number" class="form-control" name="name1" 
