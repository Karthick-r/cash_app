...
$last_reading= Reading::where('store_id',$s_id)->where('route_id',$r_id)->where('user_id',$u_id)->orderBy('reading_id', 'DESC')->first(); 
...
if(
  ...
  $last_reading->water_reading==$request->input('water_reading') &&
  $last_reading->water_maintance_reading ==$request->input('water_maintance_reading') &&
  $last_reading->today_water_reading==$request->input('water_today_reading') &&
  $last_reading->bottle_reading==$request->input('bottle_reading') &&
  $last_reading->bottle_maintance_reading==$request->input('bottle_maintance_reading') &&
  $last_reading->bottle_today_reading==$request->input('bottle_today_reading') &&
  $last_reading->cash_collect==$request->input('cash_collect') 
  )
{
