...
class DatesalesController extends Controller
{
    /**
 ...
 // return view('admin/datesales/index',['reading'=>$reading,'denominations'=>$denominations]); 
...
return view('admin/datesales/index',['reading'=>$reading,'denominations'=>$denominations,'today'=>$today,'date'=>$date,'notification'=>$notification,'route'=>$route]); 
...
else
{
   ...
   $route=route::where('deleted_on_off', '1')->get();
            ...
            return view('admin/datesales/route',['reading'=>$reading,'denominations'=>$denominations, 'val'=>$st,'today'=>$today,'date'=>$date,'notification'=>$notification,'route'=>$route]); 
